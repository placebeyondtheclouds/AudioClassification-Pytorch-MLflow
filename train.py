...
import os # by placebeyondtheclouds

parser = argparse.ArgumentParser(description=__doc__)
add_arg = functools.partial(add_arguments, argparser=parser)
add_arg('configs',          str,    'configs/current_cam++.yml',        '配置文件')
add_arg("local_rank",       int,    os.environ['LOCAL_RANK'],                          '多卡训练需要的参数') # by placebeyondtheclouds
